...
\begin{tad}{\tadNombre{LinkLinkIt}}
	...
	\tadAxioma{díasAccesosRecientes(registrarAcceso($l$, $d$, $lli$))}{
		\IF díaÚltimoAcceso($lli$) = 0
		THEN Ag(0, $\emptyset$)
		ELSE
			({\IF díaÚltimoAcceso($lli$) = 1
			THEN Ag(1, Ag(0, $\emptyset$))
			ELSE
				Ag(díaÚltimoAcceso($lli$),\\
					\hspace*{5mm}Ag(díaÚltimoAcceso($lli$) - 1,\\
						\hspace*{10mm}Ag(díaÚltimoAcceso($lli$) - 2, $\emptyset$)))				
			FI})
		FI
	}	
